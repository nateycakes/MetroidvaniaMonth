...
export(SPAWN_ZONE_TYPES) var spawn_zone_type = SPAWN_ZONE_TYPES.SAVE_POINT
#from_room_path is the room the scene the player would be entering from in order to spawn here
export(String, FILE, "*.tscn") var from_room_path = ""
...
export(String, 
	...
	"EXIT_UP",
	"EXIT_DOWN"
) var transition_type = "ENTER_LEFT"
